...
//static char *font = "Triplicate T4c:pixelsize=22:antialias=true:autohint=true";
//static char *font = "Operator Mono Book:pixelsize=20:antialias=true:autohint=true";
...
// Ocean Depths Dark Terminal Theme
{{"#2D3033", "#E45649", "#04BF9D", "#FFC857", 
 "#5FCDD9", "#9C5FD9", "#04BFAD", "#D8D8D8",
 "#555555", "#FF7B6B", "#04D9AD", "#FFD787",
 "#82E5F0", "#B57FF0", "#04D9C9", "#FAFAFA",
 [256]="#027373", "#CECECE"}, 7, 0, 256, 257},

// Ocean Depths Terminal Theme (Refined)
{{"#2E3134", "#E45649", "#03B395", "#EDBC59", 
 "#53C1CC", "#956FD0", "#04B0A0", "#D8D8D8",
 "#555555", "#FF7B6B", "#04D1A5", "#FFD787",
 "#76D7E2", "#AC85E6", "#04C9BA", "#FAFAFA",
 [256]="#026464", "#CECECE"}, 7, 0, 256, 257},
 };
