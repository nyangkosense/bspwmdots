...
static const char *fonts[]          = { "scientifica:size=20" };
static const char dmenufont[]       = "monospace:size=10";
static const char col_gray1[]       = "#1e1f29";
static const char col_gray2[]       = "#50fa7b";
...
static const char *const autostart[] = {
	"st", NULL,
	"sh","-c","/home/$USER/.scripts/auto.sh", NULL,
	NULL /* terminate */
};

/* tagging */
static const char *tags[] = { "0:term", "1:misc", "2:dev", "3:wrk", "4:teams"};
